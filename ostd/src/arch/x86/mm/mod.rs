...
impl PageTableEntry {
    ...
    const PROP_MASK: usize = !Self::PHYS_ADDR_MASK & !PageTableFlags::HUGE.bits() & !PageTableFlags::VALID_PAGE.bits();
}
...
impl PageTableEntryTrait for PageTableEntry {
    ...
    fn prop(&self) -> PageProperty {
        ...
        // Standard PAT index encoding (assuming default PAT MSR values):
        // PAT PCD PWT -> Memory Type
        //  0   0   0  -> WB (Writeback)
        //  0   0   1  -> WT (Writethrough)
        //  0   1   0  -> UC- (Uncacheable)
